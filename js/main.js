...
/*function checkPassword(){
    ...
    var seguridad = document.getElementById('seguridadPassword');
    if(password.value === null || password.value === '' ){
        seguridadPassword.innerHTML = "esta vacio!";
...
function reset(){ 
    ...
    var password = document.getElementById('mensajePasswordEmpty');
    password.value = " ";
...
function calcularCantidadesPassword(secuenciaArmada){
    ...
    while( i < cantCaracteres -1){
        if(sonIguales(secuenciaArmada[i],secuenciaArmada[i+1])){
            cantIguales++;
            var total = document.getElementById("cantIguales");
            total.innerHTML = cantIguales;
    ...
    var consecutivoss = document.getElementById("cantConsecutivos");
    consecutivoss.innerHTML = cantConsecutivos;
...
function consecutivosNumericos(elem1,elem2){
  if (elem1 + 1 === elem2 || elem1 - 1 === elem2) {
    return true;
  } else {
    return false;
  }}
...
elem1 = integer.charCodeAt(a); 
 elem2 = integer.charCodeAt(b);
 var c = elem1 - elem2;
